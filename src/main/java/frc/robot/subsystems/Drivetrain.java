...
import frc.robot.utils.ModuleToChassisSpeeds;
import frc.robot.utils.OneDimensionalLookup;

import static frc.robot.Constants.*;
import static frc.robot.config.DrivetrainCals.*;
...
public class Drivetrain implements Subsystem {
    ...
    public Drivetrain(IntakeSubsystem intake, XboxController controller, Limelight limelight, ArmSubsystem arm) {
        ...
        frontLeftModule = Mk4SwerveModuleHelper.createFalcon500(
            ...
            SwerveConstants.Mod0.talonSRXID,
            // This is how much the steer encoder is offset from true zero (In our case, zero is facing straight forward)
            SwerveConstants.Mod0.STEER_OFFSET_RADIANS
        );
        ...
        frontRightModule = Mk4SwerveModuleHelper.createFalcon500(
            ...
            SwerveConstants.Mod1.talonSRXID,
            SwerveConstants.Mod1.STEER_OFFSET_RADIANS
        );
        ...
        backLeftModule = Mk4SwerveModuleHelper.createFalcon500(
            ...
            SwerveConstants.Mod2.talonSRXID,
            SwerveConstants.Mod2.STEER_OFFSET_RADIANS
        );
        ...
        backRightModule = Mk4SwerveModuleHelper.createFalcon500(
            ...
            SwerveConstants.Mod3.talonSRXID,
            SwerveConstants.Mod3.STEER_OFFSET_RADIANS
        );
        ...
        pigeon2 = new Pigeon2(SwerveConstants.pigeonID, "Drivetrain");
        ...
        //TODO TEMPORARY
        odometry = new SwerveDriveOdometry(m_kinematics,Rotation2d.fromDegrees(0.0), getModulePositions());
        resetOdometry();
    ...
    private SwerveModulePosition[] getModulePositions() {
        return new SwerveModulePosition[] {
            getPosition(frontLeftModule), getPosition(frontRightModule),
            getPosition(backLeftModule), getPosition(backRightModule)
        };
    }

    private SwerveModulePosition getPosition(SwerveModule mod) {
        //TODO: Implement getDistance() methods using drive motor encoders.
        //See https://github.com/wpilibsuite/allwpilib/tree/main/wpilibjExamples/src/main/java/edu/wpi/first/wpilibj/examples/swervebot
        return new SwerveModulePosition(12.5, new Rotation2d(10.0));
            //mod.getDistance(), new Rotation2d(mod.getSteerEncoder().getDistance()));
    }
    ...
    public void initAutonPosition(PathPlannerTrajectory.PathPlannerState state){
        ...
        odometry.resetPosition(getGyroscopeRotation(), getModulePositions(), new Pose2d(0, 0, new Rotation2d()));
    }
